...
from src.models.decomposition import operations as op
...
def test_multi_mode_product():
    ...
    output1 = op.multi_mode_product(tensor, matrices, transpose=False)
...
# total_time = timeit(
#     "op.multi_mode_product(tensor, matrices, modes=None, transpose=False)",
#     number=100,
#     globals=globals(),
# )
