...
# Train
torchrun train.py dist.backend=nccl dist.nproc_per_node=2 dist.nnodes=1 task_name=train_${TASK_NAME} data=cifar100 metric=cifar10 model=dct_model_cifar model.num_classes=100 model.rescale=false
