...
sbatch --account=lp_inspiremed --job-name=patchsvd_imagenet_pretrained_resnet50 --clusters=genius --nodes=1 --ntasks-per-node=1 --cpus-per-task=9 --gres=gpu:1 --time=20:00 --partition=gpu_p100_debug patchsvd_imagenet_pretrained_resnet50.sh
