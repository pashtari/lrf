...
interpolate_flops = []
interpolate_ratios = []
for new_size in range(48, 225, 8):
    ...
    interpolate_ratios.append(interpolate_model.real_compression_ratio)

# PatchSVD
patchsvd_flops = []
patchsvd_ratios = []
for rank in range(192, 193, 7):
    ...
    patchsvd_ratios.append(patchsvd_model.real_compression_ratio)
