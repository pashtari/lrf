...
\begin{proposition}[Meeting required assumptions]\label{prop:assumptions}
...
\begin{proposition}[Global convergence \cite{bolte2014proximal}]\label{prop:convergence}
...
\begin{lemma}[$\prox$ implementation]
