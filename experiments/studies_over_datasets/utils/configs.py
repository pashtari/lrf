...
def parse_args():
    ...
    parser.add_argument("--data_dir", default="/Users/pourya/Desktop/Remote/vsc/vsc_scratch/", type=str)
    parser.add_argument("--experiment_name", default="test", type=str)
    parser.add_argument("--patch_size", default=8, type=int)
    parser.add_argument("--bounds", default=16, type=int)
    parser.add_argument("--num_iters", default=10, type=int)
    parser.add_argument("--patchify", action=argparse.BooleanOptionalAction)
