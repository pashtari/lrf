...
sbatch --account=lp_inspiremed --job-name=clsi_SVD --clusters=genius --nodes=1 --ntasks-per-node=2 --cpus-per-task=4 --gres=gpu:1 --time=24:00:00 --partition=gpu_v100 SVD_imagenet_classification.sh
sbatch --account=lp_inspiremed --job-name=clsi_JPG --clusters=genius --nodes=1 --ntasks-per-node=2 --cpus-per-task=4 --gres=gpu:1 --time=24:00:00 --partition=gpu_v100 JPEG_imagenet_classification.sh